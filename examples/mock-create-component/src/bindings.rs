    ...
    pub mod example {
        ...
        pub mod create {
            ...
            pub mod create {
                ...
                pub trait Guest {
                    fn create() -> Result<_rt::String, _rt::String>;
                }
                #[doc(hidden)]

                macro_rules! __export_example_create_create_0_1_0_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "example:create/create@0.1.0#create"]
          unsafe extern "C" fn export_create() -> *mut u8 {
            $($path_to_types)*::_export_create_cabi::<$ty>()
          }
          #[export_name = "cabi_post_example:create/create@0.1.0#create"]
          unsafe extern "C" fn _post_return_create(arg0: *mut u8,) {
            $($path_to_types)*::__post_return_create::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_example_create_create_0_1_0_cabi;
                #[repr(align(4))]
...
macro_rules! __export_app_impl {
  ...
  $($path_to_types_root)*::exports::example::create::create::__export_example_create_create_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::example::create::create);
  )
}
#[doc(inline)]
...
B\x03\x01j\x01s\x01s\x01@\0\0\0\x04\0\x06create\x01\x01\x04\x01\x20example:\
create/create@0.1.0\x05\0\x04\x01\x1dexample:create/app@0.1.0\x04\0\x0b\x09\

...
// Package types represents the imported interface "wasmcloud:wash/types@0.0.2".
package types
...
// HookType represents the enum "wasmcloud:wash/types@0.0.2#hook-type".
//
...
// CommandArgument represents the record "wasmcloud:wash/types@0.0.2#command-argument".
//
...
// Command represents the record "wasmcloud:wash/types@0.0.2#command".
//
...
// Metadata represents the record "wasmcloud:wash/types@0.0.2#metadata".
//
...
// PluginConfig represents the imported resource "wasmcloud:wash/types@0.0.2#plugin-config".
//
...
// ProjectConfig represents the imported resource "wasmcloud:wash/types@0.0.2#project-config".
//
...
// Context represents the imported resource "wasmcloud:wash/types@0.0.2#context".
//
...
// Runner represents the imported resource "wasmcloud:wash/types@0.0.2#runner".
//
...
// HostExecBackground represents the imported method "host-exec-background".
//
...
//
//go:nosplit
func (self Runner) HostExecBackground(bin string, args cm.List[string]) (result cm.Result[string, struct{}, string]) {
	self0 := cm.Reinterpret[uint32](self)
	bin0, bin1 := cm.LowerString(bin)
	args0, args1 := cm.LowerList(args)
	wasmimport_RunnerHostExecBackground((uint32)(self0), (*uint8)(bin0), (uint32)(bin1), (*string)(args0), (uint32)(args1), &result)
	return
}

...
impl CliContext {
    ...
    pub async fn new() -> anyhow::Result<Self> {
        ...
        let plugin_runtime = wasmcloud::host::Host::builder()
        ...
        // Should discover all plugins, create workloads, initialize them
        // TODO: plugin_manager.initialize(plugin_runtime.clone()).await?;
